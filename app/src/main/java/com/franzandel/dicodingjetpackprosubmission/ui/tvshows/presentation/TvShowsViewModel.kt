...
class TvShowsViewModel(private val tvShowsRepository: TvShowsRepository) : ViewModel() {
    ...
    private var _tvShowsSource: LiveData<Resource<TvShowsAPI>> = MutableLiveData()
    private val _tvShowsResult = MediatorLiveData<TvShowsAPI>()
    val tvShowsResult: LiveData<TvShowsAPI> = _tvShowsResult
